...
class WindowedFunc(object):
    def __init__(self,size_in,size_out,function='variance',window_size=10):
        self.size_in = size_in
        self.size_out = size_out
    ...
    def __call__(self,t,x):
        ...
        return np.var(self.history,axis=0)
...
with model:
    ...
    inj = nengo.Node( nengo.processes.PresentInput( inputs = [-1., 1.], presentation_time = 1.) )
